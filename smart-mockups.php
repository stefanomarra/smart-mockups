...
define( 'SMART_MOCKUPS_VERSION'			, '1.0.4' );

/**
 * The code that runs during plugin activation.
 */
function activate_smart_mockups() {
	require_once SMART_MOCKUPS_DIR . 'includes/class-smart-mockups-activator.php';
...
function deactivate_smart_mockups() {
	require_once SMART_MOCKUPS_DIR . 'includes/class-smart-mockups-deactivator.php';
 ...
 */
require SMART_MOCKUPS_DIR . 'includes/class-smart-mockups.php';
